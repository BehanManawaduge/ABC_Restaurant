...
public class ManageReservationsController {
    ...
    private void loadReservations() {
        ObservableList<Reservation> reservationsList = FXCollections.observableArrayList(reservationController.getAllReservations());
    ...
    public void handleDeleteReservation() {
        ...
        if (selectedReservation != null) {
            reservationController.deleteReservation(selectedReservation.getReservationId());
