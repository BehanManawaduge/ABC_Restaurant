...
public class HotelShow {
    ...
    public void initdata(String s1,String s2){
        ...
        recv2= s2;
        HRS hrs=new HRS();
        Restaurant customer=hrs.searchHotelByNameLoc(recv1,recv2);
        HName.setText(customer.getName());
        HLocation.setText(customer.getLocation());
        HDoublePrice.setText(customer.getDoubletableprice());
        HDoubleRooms.setText(customer.getDoubletable());
        HSingleRooms.setText(customer.getSingletable());
        HAddress.setText(customer.getAddress());
        HTotalRooms.setText(Integer.toString(customer.getTotalRooms()));
        HSinglePrice.setText(customer.getSingletableprice());
