...
public class writerAndReader {
    ...
    public void writeHotelIntoFile(Restaurant h) {
        try {
            ...
            bufferedWriter.append(h.getID() + "," + h.getName() + "," + h.getAddress() + "," + h.getLocation() + "," + h.getSingletable() + ",");
            bufferedWriter.append(h.getDoubletable() + "," + h.getSingletableprice() + "," + h.getDoubletableprice() + "\n");
            bufferedWriter.close();
        } catch (Exception error) {
            System.err.println("Error: " + error.getMessage());
        }
    ...
    public void readHotelsFromFile(Vector<Restaurant> restaurants) {
        Restaurant h;
            ...
            while ((value = bufferReader.read()) != -1) {
                ...
                if (character != ',' && character != '\n') {
                    ...
                    if (temp == 1) {
                        ...
                        dRoomPrice = strLine;
                        h = new Restaurant(ID, name, address, location, sRooms, dRooms, sRoomPrice, dRoomPrice);
                        restaurants.add(h);
                        temp = 0;
                        name = "";
                        address = "";
    ...
    public void writeRoomsIntoFile(Restaurant h) {
        try {
    ...
    public void readRoomsFromFile(Restaurant restaurant) {
